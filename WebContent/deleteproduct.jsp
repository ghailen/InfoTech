...
<center><h5 id="success" style="display: none;"> Product deleted Successfully</h5></center>
                        <p class="ti-arrow-up">
        <div class="content">
            <div class="container-fluid">
                <div class="row">
...
while(resultSet.next()){
	%>                                
                                        ...
                                        <tr>
                                        	...
                                        	<input type="text" name="b1" style="display:none;" value="<%=resultSet.getString("id") %>">
                                        	</td>
...
String b = request.getParameter("b1");       
  ...
  int prodID = Integer.parseInt(b);
  
int updateQuery = 0;


    String sql2 = "DELETE FROM produit WHERE id="+prodID ; 
